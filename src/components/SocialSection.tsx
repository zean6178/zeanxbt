...
const socials = [
  {
    ...
    description: "Daily thoughts on AI & Web3",
  },
  {
    name: "YouTube",
    handle: "@zeanXBT",
    ...
    description: "Full AI video content",
  },
  {
    name: "Instagram",
    handle: "@zeanxbt",
    ...
    description: "Behind the scenes & short clips",
  },
  {
    name: "TikTok",
    handle: "@zeanxbt",
    ...
    description: "Short AI video content",
  },
  {
    name: "Threads",
    handle: "@zeanxbt",
    url: "https://threads.net/@zeanxbt",
    icon: (
      <svg viewBox="0 0 24 24" className="w-6 h-6 fill-current">
