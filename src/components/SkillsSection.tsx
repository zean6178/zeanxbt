...
const skillGroups = [
  {
    category: "Community",
    items: ["Discord Moderation", "Telegram Management", "Community Growth", "Ambassador Programs"],
  },
  {
    category: "Creative",
    items: ["AI Video Editing", "Midjourney / AI Tools", "Content Creation", "Brand Identity Design"],
  },
  {
    category: "Strategy",
    items: ["Web3 Marketing", "X / Twitter Growth", "Event Coordination", "Alpha Research"],
  },
];

export default function SkillsSection() {
  return (
    <section id="skills" className="py-[clamp(100px,12vw,160px)] px-6 md:px-12 lg:px-16 xl:px-24 bg-gradient-to-b from-black via-[#020508] to-black">
      <motion.div
